...
## Type: Font
c.fonts.tabs.selected = '12pt DejaVuSansMono Nerd Font'

## Font used for unselected tabs.
## Type: Font
c.fonts.tabs.unselected = '12pt DejaVuSansMono Nerd Font'
...
config.bind('<Alt-v>', 'hint links userscript ~/.local/bin/ytdlv')
